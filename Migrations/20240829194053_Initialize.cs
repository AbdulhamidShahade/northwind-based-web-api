...
namespace NorthwindBasedWebAPI.Migrations
{
    ...
    public partial class Initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CustomersCustomerDemographics",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomersCustomerDemographics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomersCustomerDemographics_CustomerDemographics_CustomerTypeId",
                        column: x => x.CustomerTypeId,
                        principalTable: "CustomerDemographics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomersCustomerDemographics_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeesTerritories", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomersCustomerDemographics_CustomerId",
                table: "CustomersCustomerDemographics",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomersCustomerDemographics_CustomerTypeId",
                table: "CustomersCustomerDemographics",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeesTerritories_EmployeeId",
